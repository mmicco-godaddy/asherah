...
public class SecureMemorySecretFactoryTest
{
    ...
    private void TestMlockConfigurationSettingForMacWithInvalidValueThrowsException()
    {
        ...
        Assert.Throws<SecureMemoryConfigurationException>(() => SecureMemorySecretFactory.ConfigureForMacOS64(configuration));
    }
    ...
    private void TestMlockConfigurationSettingForLinuxWithInvalidValueThrowsException()
    {
        ...
        Assert.Throws<SecureMemoryConfigurationException>(() => SecureMemorySecretFactory.ConfigureForLinux64(configuration));
    }
